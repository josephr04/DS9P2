...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nuevoUsuario)) {
    ...
    } elseif (strlen($nuevoUsuario) < 5) {
        $errorMsg = 'El usuario debe tener mínimo 5 caracteres.';
    } elseif (str_contains($nuevoUsuario, ' ')) {
        $errorMsg = 'El usuario no puede contener espacios.';
    } elseif ($idUsuario === 0) {
        $errorMsg = 'Error: sesión no válida.';
    } else {
        $payload = json_encode(['nuevo_usuario' => $nuevoUsuario]);
        $ch = curl_init(API_BASE . "/usuarios/{$idUsuario}/cambiar-usuario");
        ...
        if ($code === 200) {
            ...
            $successMsg = 'Nombre de usuario actualizado correctamente.';
        } elseif ($code === 409) {
            $errorMsg = 'El nombre de usuario ya está en uso.';
        } elseif ($code === 404) {
            $errorMsg = 'Usuario no encontrado.';
        } else {
            $errorMsg = 'Error al actualizar el usuario. Intenta nuevamente.';
        }
    }
}

$usuarioActual = $_SESSION['username'] ?? 'Administrador';
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Cambiar Usuario - Panel Administrador</title>
...
<div class="page-container">
    <div class="page-header">
        <div>
            <h1><i class="fas fa-user-edit"></i> Cambiar Usuario</h1>
            <p>Actualiza tu identificador de acceso</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Cambiar Usuario</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="page-content">
        <div class="content-wrapper">
            ...
            <div class="info-banner">
                ...
                El nombre de usuario es tu identificador único. Este será visible en tus aplicaciones y documentos compartidos.
            </div>
            ...
            <div class="form-card">
                <label class="field-label">Usuario Actual</label>
                ...
                <form method="POST" action="">
                    <label class="field-label" for="nuevo_usuario">Nuevo Usuario</label>
                    <div class="input-group-custom">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['nuevo_usuario'] ?? '') ?>"
                            autocomplete="off"
                        >
                    </div>

                    <div class="requirements-box">
                        <div class="req-title">Requisitos del usuario</div>
                        <div class="req-item"><i class="fas fa-check"></i> Mínimo 5 caracteres</div>
                        <div class="req-item"><i class="fas fa-check"></i> Sin espacios</div>
                    </div>
