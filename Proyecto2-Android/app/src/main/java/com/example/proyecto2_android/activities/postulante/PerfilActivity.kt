...
class PerfilActivity : AppCompatActivity() {
    ...
    private fun setupSpinners() {
        ...
        spinner(spinnerEstadoCivil, listOf(
            "Seleccione...", "Soltero/a", "Casado/a", "Divorciado/a", "Viudo/a", "Unión libre"
        ))

        spinner(spinnerTipoSangre, listOf(
            "Seleccione...", "A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"
        ))

        spinner(spinnerNivelAcademico, listOf(
            "Seleccione...", "Primaria", "Secundaria", "Técnico", "Universitario",
        ...
        // Distrito y Corregimiento se cargarán dinámicamente según Provincia
        ...
        // Actualizar Corregimiento al cambiar Distrito
    ...
    private fun setupDatePicker() {
        etFechaNacimiento.setOnClickListener {
            ...
            DatePickerDialog(
                ...
                cal.get(Calendar.YEAR) - 18,   // default: 18 años atrás
    ...
    private fun setupBottomNav() {
        ...
        bottomNav.setOnItemSelectedListener { item: MenuItem ->
            when (item.itemId) {
                ...
                R.id.nav_documentos  -> {
                    // TODO: navegar a DocumentosActivity
                    true
                }
                R.id.nav_ajustes     -> {
    ...
    private fun validarCampos(): Boolean {
        ...
        // Validar spinners obligatorios (posición 0 = "Seleccione...")
    ...
    private fun enviarSolicitud() {
        // TODO: conectar con tu API / ViewModel
